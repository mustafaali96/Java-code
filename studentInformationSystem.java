...
public class studentInformationSystem extends JFrame implements ItemListener,ActionListener, ListSelectionListener{ 
	...
	String [] listcity= {"Surigao City","Butuan City","Davao City","Cebu City","Tagum City","Dipolog City","Quezon City","Makati City","Pasig City","Pasay City"};
    ...
    //***********************************************************checkbox
    	panel.add (CBDiploma);
    		...
    		CBDiploma.addActionListener((ActionEvent event) -> {
                    JCheckBox CBDiploma1 = (JCheckBox)event.getSource();
        if (CBDiploma1.isSelected()) {
   ...
   try{
    ...
    public void actionPerformed (ActionEvent e){
    		...
    		if(source == save){
    			...
    			if (!status.equals("")&&!gender.equals("")&&!idf.equals("") && !ftname.equals("")&& !mdname.equals("") && !ltname.equals("") && !agef.equals("")&& !citycd.equals("")){
